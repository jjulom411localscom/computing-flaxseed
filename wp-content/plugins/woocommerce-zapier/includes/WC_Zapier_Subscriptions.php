 ...
 *
 * Plugin URL: https://www.woothemes.com/products/woocommerce-subscriptions/
 *
...
class WC_Zapier_Subscriptions {
	 ...
	 */
	const MINIMUM_SUPPORTED_SUBSCRIPTIONS_VERSION = '2.0.12';
	...
	public function admin_notice() {
		...
		<div id="message" class="error">
			<p><?php printf( __( 'The WooCommerce Zapier Integration plugin is only compatible with WooCommerce Subscriptions version %s or later. Please update WooCommerce Subscriptions.-Null24.Net', 'wc_zapier' ), self::MINIMUM_SUPPORTED_SUBSCRIPTIONS_VERSION ); ?></p>
		</div>
		<?php
	}
