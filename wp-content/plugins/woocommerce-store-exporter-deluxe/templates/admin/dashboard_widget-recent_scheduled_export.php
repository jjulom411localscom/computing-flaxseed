...
<ol>
	...
	<li>
		<p>
			<?php echo $recent_export['name']; ?><?php if( !empty( $recent_export['post_id'] ) && get_post_status( $recent_export['post_id'] ) !== false ) { ?> <a href="<?php echo get_edit_post_link( $recent_export['post_id'] ); ?>">#</a><?php } ?>
		</p>
		<p>
		...
		<?php } ?>
			<span title="<?php echo woo_ce_format_date( date( 'd/m/Y h:i:s', $recent_export['date'] ), 'd/m/y h:i:s' ); ?>"><?php echo woo_ce_format_archive_date( $recent_export['post_id'], $recent_export['date'] ); ?></span>,
