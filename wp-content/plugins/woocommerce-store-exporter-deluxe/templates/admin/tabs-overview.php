...
-->
	...
	<h3><div class="dashicons dashicons-list-view"></div>&nbsp;<a href="<?php echo esc_url( add_query_arg( 'tab', 'export_template' ) ); ?>"><?php _e( 'Export Templates', 'woocommerce-exporter' ); ?></a></h3>
