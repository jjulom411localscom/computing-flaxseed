...
<table class="wc_status_table widefat" cellspacing="0">
	<thead>
		<tr>
			<th colspan="3" data-export-label="Templates"><?php _e( 'Store Exports', 'woocommerce-store-toolkit' ); ?><?php echo wc_help_tip( __( 'This section shows diagnostic details for Store Exporter Deluxe.', 'woocommerce-exporter' ) ); ?></th>
		</tr>
	</thead>
	<tbody>
		<tr>
			<td data-export-label="<?php _e( 'Scheduled Export to FTP', 'woocommerce-exporter' ); ?>"><?php _e( 'Export to FTP', 'woocommerce-exporter' ); ?></td>
			<td class="help"><?php echo wc_help_tip( __( 'Displays whether or not the current hosting account supports exporting to FTP.', 'woocommerce' ) ); ?></td>
			<td><?php
	if(
		function_exists( 'ftp_connect' ) && 
		function_exists( 'ftp_get_option' ) && 
		function_exists( 'ftp_set_option' ) && 
		function_exists( 'ftp_login' ) && 
		function_exists( 'ftp_raw' ) && 
		function_exists( 'ftp_pasv' ) && 
		function_exists( 'ftp_pwd' ) && 
		function_exists( 'ftp_chdir' ) && 
		function_exists( 'ftp_put' ) && 
		function_exists( 'ftp_fput' ) && 
		function_exists( 'ftp_size' ) && 
		function_exists( 'ftp_delete' )
	) {
		echo '<mark class="yes"><span class="dashicons dashicons-yes"></span></mark>';
	} else {
		echo '<mark class="error"><span class="dashicons dashicons-no-alt"></span> ' . __( 'The required FTP functions are not available', 'woocommerce-exporter' ) . '</mark>';
	}
?>
			</td>
		</tr>
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( __( 'Displays whether or not the current hosting account supports exporting to SFTP.', 'woocommerce' ) ); ?></td>
			<td><?php
	if(
		...
		echo '<mark class="error"><span class="dashicons dashicons-no-alt"></span> ' . __( 'The required SFTP functions are not available', 'woocommerce-exporter' ) . '</mark>';
	}
?>
			</td>
		</tr>
