...
// add_action( 'woo_ce_export_settings_general', 'woo_ce_export_settings_multisite' );
...
<tr>
	<th><?php _e( 'Attribute display', 'woocommerce-exporter' ); ?></th>
	<td>
		<ul>
...
<tr>
	<th><?php _e( 'Actions display', 'woocommerce-exporter' ); ?></th>
	<td>
		<ul>
