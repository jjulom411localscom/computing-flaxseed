...
Startuply = {
        ...
        setPageOptions: function() {
            var e = this;
            $("body").is(".home") && (e.homePage = !0), (e.mobileMainMenuMod && e.homePage || e.mobileMenuMod && !e.homePage) && (e.mobileMenu = !0, $("body").addClass("mobile-always"))
        },
...
$(document).ready(function(){
    ...
    $('.dg-one-scoop .btn-add-cart').after('<h6 class="mbg">*MONEY BACK GUARANTEED</h6>');
    ...
    $('.sub-footer').append('<div class="copyright-block"><div class="container "><div class="cright">Copyright 2016 © Natural Life Inc. - All right reserved</div></div></div>');
   ...
   var sswc = 'support-sum support-sec wpb_column column_container';

    $('.type-product > div.summary.entry-summary').after('<div class="' + sswc + '  "><div class="wpb_wrapper"><div class="wpb_text_column wpb_content_element alignleft text-c-sup"><div class="wpb_wrapper"><div class="' + wtcts + '" style=" color: #b4cc1a;"><p>Customer Support</p></div> </div></div><div class="wpb_text_column wpb_content_element alignleft text-need-ast"><div class="wpb_wrapper"><div class="' + wtcts + '" style=" color: #b4cc1a;"><p>Need Assistance?</p></div>    </div></div><div class="wpb_text_column wpb_content_element  contact-block"><div class="wpb_wrapper"><div class="' + wtcts + '" style=" color: #676767;"><p>Call us at 888-860-2323</p><p>Email us at hi@behealthy.com</p></div>   </div></div><div class="wpb_text_column wpb_content_element alignleft sched-block"><div class="wpb_wrapper"><div class="' + wtcts + '" style=" color: #676767;"><p>Monday to Saturday</p><p>8:00am – 5:00pm PST</p><p>Sunday</p><p>9:00am – 5:00pm PST</p></div>   </div></div><div class="wpb_text_column wpb_content_element  policy-block"><div class="wpb_wrapper"><div class="' + wtcts + '" style=" color: #b4cc1a;"><p><a href="#">Shipping Policy</a></p><p><a href="https://behealthy.today/return-policy/">Return Policy</a></p><p><a href="https://behealthy.today/privacy-policy/">Privacy Notice</a></p></div>   </div></div></div></div>');
    ...
    $('#customer_details > div.col-1').after('<div class="' + sswc + ' "> <div class="wpb_wrapper"> <div class="wpb_text_column wpb_content_element alignleft text-c-sup"> <div class="wpb_wrapper"> <div class="' + wtcts + '" style=" color: #b4cc1a;"> <p>Customer Testimonial</p></div></div></div><div class="wpb_text_column wpb_content_element alignleft text-c-test"> <div class="wpb_wrapper"> <div class="' + wtcts + '" style=" color: #b4cc1a;"><div class="client-img"></div> <div class="tes-message">I have more energy to keep up with my busy life. If I miss a day or two, I notice I have less energy & don’t feel as happy, I also feel like I’m doing something good for my body since it’s so hard to get all the veggies I need. I’m sold on my greens!</div></div></div></div><div class="wpb_text_column wpb_content_element alignleft text-100"> <div class="wpb_wrapper"> <div class="' + wtcts + '" style=" color: #b4cc1a;"> <div class="c-ben 100"><div class="toni"></div><div>100% Money Back Guarantee</div></div><p>You have a ful 30 days to use the Advanced Marketing Program. During thattime if you decide it’s not right for you, just let us knwo and we’ll issue you a fullrefund. No questions asked!</p></div></div></div><div class="wpb_text_column wpb_content_element alignleft text-s-check"> <div class="wpb_wrapper"> <div class="' + wtcts + '" style=" color: #b4cc1a;"> <div class="c-ben s-c"><div class="toni"></div><div>Secure Checkout</div></div><p>All of your information is secure and encrypted/ We don’t take security lightly and so we always use the latest security protocols.</p></div></div></div><div class="wpb_text_column wpb_content_element alignleft text-s-check"> <div class="wpb_wrapper"> <div class="' + wtcts + '" style=" color: #b4cc1a;"> <div class="c-ben su"><div class="toni"></div><div>Support</div></div><p>Email Us Anytime: <a href="mailto:hi@behealthy.today">hi@behealthy.today</a></p></div></div></div></div></div>');

    $('#main-content > div > .woocommerce').addClass('container');
});
$( document ).ajaxComplete(function() {
    var aclass = 'class="more-link static">Read More</a>';
        slc1 = '.alm-one div:nth-child';
        slc2 = '.alm-two div:nth-child';
        ahr = '<a href="';
        slac = '#ajax-load-more > div.alm-listing.alm-ajax > div.alm-reveal:nth-child';
    function set_button(){
        $(slac + '(1)').addClass('alm-one');
        $(slac + '(2)').addClass('alm-two');
        $(slc1 + '(2) > a').before(ahr + '/healthy-weight-loss-smoothies/"' + aclass);
        $(slc1 + '(4) > a').before(ahr + '/wheat-grass-facts-benefits/"' + aclass);
        $(slc1 + '(5) > a').before(ahr + '/ingredient/oat-grass/"' + aclass);
        $(slc1 + '(6) > a').before(ahr + '/yerba-mate-health-benefits/"' + aclass);
        $(slc1 + '(7) > a').before(ahr + '/bee-pollen-top-10-benefits/"' + aclass);
        $(slc1 + '(2) > div:nth-child(1) > a').before(ahr + '/healthy-weight-loss-smoothies/"' + aclass);
    }
    set_button();
        $(slc2 + '(3) > a').before(ahr + '/health-juice-weight-loss/"' + aclass);
        $(slc2 + '(4) > a').before(ahr + '/health-juice-weight-loss/"' + aclass);
        $(slc2 + '(6) > a').before(ahr + '/fruit-juices-healthy-skin/"' + aclass);
        $(slc2 + '(7) > a').before(ahr + '/wheat-grass-facts-benefits/"' + aclass);
        $(slc2 + '(9) > a').before(ahr + '/acidophilus-probiotic-benefits/"' + aclass);
