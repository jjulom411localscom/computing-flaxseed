...
Startuply = {
    ...
    $(document).ready(function(){
    	$('nav .container').append('<a href="/pure-ocean/?add-to-cart=3837" class="btn btn-solid order-now">Order now</a>');
    });
...
$(document).ready(function(){
    ...
    $(window).scroll(function(event){
       ...
       if (st > lastScrollTop){
           // downscroll code
           $('#landing-page > header:nth-child(3) > nav').addClass('fixmenu-clone');
       } else {
          // upscroll code
          $('#landing-page > header:nth-child(3) > nav').removeClass('fixmenu-clone');
       }
       lastScrollTop = st;
    });
    ...
    $('#product-3837 > div.summary.entry-summary').after('<div class="support-sum support-sec wpb_column column_container  "><div class="wpb_wrapper"><div class="wpb_text_column wpb_content_element alignleft text-c-sup"><div class="wpb_wrapper"><div class="wpb_text_column-text-style" style=" color: #b4cc1a;"><p>Customer Support</p></div> </div></div><div class="wpb_text_column wpb_content_element alignleft text-need-ast"><div class="wpb_wrapper"><div class="wpb_text_column-text-style" style=" color: #b4cc1a;"><p>Need Assistance?</p></div>    </div></div><div class="wpb_text_column wpb_content_element  contact-block"><div class="wpb_wrapper"><div class="wpb_text_column-text-style" style=" color: #676767;"><p>Call us at 888-860-2323</p><p>Email us at hi@behealthy.com</p></div>   </div></div><div class="wpb_text_column wpb_content_element alignleft sched-block"><div class="wpb_wrapper"><div class="wpb_text_column-text-style" style=" color: #676767;"><p>Monday to Saturday</p><p>8:00am – 5:00pm PST</p><p>Sunday</p><p>9:00am – 5:00pm PST</p></div>   </div></div><div class="wpb_text_column wpb_content_element  policy-block"><div class="wpb_wrapper"><div class="wpb_text_column-text-style" style=" color: #b4cc1a;"><p><a href="#">Shipping Policy</a></p><p><a href="https://behealthy.today/return-policy/">Return Policy</a></p><p><a href="https://behealthy.today/privacy-policy/">Privacy Notice</a></p></div>   </div></div></div></div>');
