		...
		function add_iecg_admin_page(){
							  ...
							  '	iecg_title_reply' );*/
								...
								add_settings_section('iecg_main',
								 ...
								 get_template_directory() . '/inc/embed-code.php');
								
												  
							 	add_options_page('Embed Code Generator Options','Embed Code Generator','edit_posts', get_template_directory() . '/inc/embed-code.php', array(&$this,'print_iecg_admin_page'));
...
?>
    <div>
          <form method="post" 
			...
			<?php do_settings_sections(get_template_directory() . '/inc/embed-code.php'); ?>
...
<?php
		...
		{		    
			wp_nonce_field( get_template_directory() . '/inc/embed-code.php',
							'iecg_noncename');
?>
...
<?php
		...
		{
			if ( !wp_verify_nonce( $_POST['iecg_noncename'],get_template_directory() . '/inc/embed-code.php' ) )
	 	       return $post_id;
...
<textarea class="embed-code" style="width:90%; height:40px; padding:5px;" readonly="readonly"><div style="clear:both"><a href="' . $linkto . '"><img src="' . $source . '"';
				if(!empty($title)){
				$content .= ' title="' . $title . '"';
				}
